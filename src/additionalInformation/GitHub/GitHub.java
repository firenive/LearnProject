...
public class GitHub {
    ...
    // git config --global user.name firenive
    ...
    // Push в основную ветвь (master) git push -u origin master

    // Contributions - кто имеет доступ к проекту и может делать в нем изменения. Новые пользователи добавляются в настройках
